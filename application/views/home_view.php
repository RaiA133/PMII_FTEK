...
<head>
    <meta charset="utf-8">
    <meta content="width=device-width, initial-scale=1.0" name="viewport"> <!--  ukuran konten dekstop == mobile -->
...
<body>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container" data-aos="zoom-out" data-aos-delay="150">
            ...
            <h2><?= $caption_2; ?></h2>
            <div class="d-flex">
                <a href="<?= base_url() ?>Gabung/gabung" target="_blank" class="btn-get-started scrollto">Gabung sekarang</a>
